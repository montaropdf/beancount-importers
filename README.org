...
**** Overtime transactions
     ...
     In case only half a day has been worked, the standard time is divided by 2. A half a day of work appear if DAYTYPE2 or (exclusive) DAYTYPE3 is MAL or CAO.

     If DAYTYPE2 is one of JFR or COLFE, the row is completely igno
